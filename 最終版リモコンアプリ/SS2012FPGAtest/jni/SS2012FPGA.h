   ...
   typedef struct
   {
      ...
      void (*playAlarmSound) (PortableServer_Servant _servant,
       ...
       CORBA_long(*getAlarmSwitchState) (PortableServer_Servant _servant,
					 CORBA_Environment * ev);
      void (*sendIrDAdata) (PortableServer_Servant _servant,
			    CORBA_long dataHigh, CORBA_short dataLow,
			    CORBA_Environment * ev);
      void (*receiveIrDAdata) (PortableServer_Servant _servant,
			       CORBA_long dataHigh, CORBA_short dataLow,
			       CORBA_Environment * ev);
...
/** stub prototypes **/
   ...
   void
      ...
      (CORBA_jp_ac_utsunomiya_is_SS2012FPGA _obj, CORBA_long dataHigh,
       CORBA_short dataLow, CORBA_Environment * ev) __attribute__ ((weak));
   void
...
#define jp_ac_utsunomiya_is_SS2012FPGA_IMETHODS_LEN 5
#ifdef ORBIT_IDL_C_IMODULE_SS2012FPGA
   static
#else
   extern
...
#define jp_ac_utsunomiya_is_SS2012FPGA_impl_cpp_type_defined
	    ...
	    class SS2012FPGA__impl:public virtual CORBA::Object
	    {
	     public:
	       ...
	       virtual void sendIrDAdata(CORBA::Long dataHigh,
					 CORBA::Short dataLow) = 0;
	       virtual void receiveIrDAdata(CORBA::Long_out dataHigh,
					    CORBA::Short_out dataLow) = 0;
	    };
	    ...
	    class SS2012FPGA:public virtual CORBA::Object
	    {
	     ...
	     public:
		  ...
		  return CORBA_interface::Utils <
	       ...
	       void sendIrDAdata(CORBA::Long dataHigh, CORBA::Short dataLow)
		  __attribute__ ((weak));
	       void receiveIrDAdata(CORBA::Long_out dataHigh,
